...
model at [Appendix: Overview of Training](/llm-inference/training/), while the discussion about
inference and serving requests continues at [Inference and the KV Cache](/llm-inference/kvcache/).
